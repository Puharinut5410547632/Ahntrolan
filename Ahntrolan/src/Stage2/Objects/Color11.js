var Color11 = cc.Sprite.extend({
    ctor: function( player ) {
      ...
      createAnimationAction: function() {
          ...
          if(this.player.room11 == 1){
              
          this.movingAction =     this.goRed();
              
          }
          
          else if(this.player.room11 == 2){
              
          this.movingAction =     this.goBlue();
              
          }
          
            else if(this.player.room11 == 3){
              
          this.movingAction =      this.goGreen();
              
          }
          
           else if(this.player.room11 == 4){
